	...
	<div style="width: 100%; position: absolute; top: 70px; bottom: 0px;">
		...
		<div id="sole" style="position: relative; display: block; margin-bottom: 5px;">
			<div style="width: 100%; position: relative;">
				<c:set value="${user.mobile}" var="contact" />
				<c:if test="${empty contact}">
					<c:set value="${user.email}" var="contact" />
				</c:if>
				<div style="margin: 2px 5px 3px; padding: 3px 5px; border: 1px solid silver; background-color: white;">
					<input id="contact" type="text" name="contact" value="${contact}" placeholder="手机/电子邮箱" style="width: 100%; height: 35px; line-height: 35px; border: 0px solid red;font-size: 14px; font-family: Arial, 'Microsoft YaHei'; outline: none; -webkit-tap-highlight-color:rgba(0,0,0,0); -webkit-user-modify:read-write-plaintext-only;"/>
				</div>
