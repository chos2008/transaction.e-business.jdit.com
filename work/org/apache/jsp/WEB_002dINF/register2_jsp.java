...
public final class register2_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t<label for=\"\" class=\"form-item-label icon-mobile2 icon-mobile2-win\" style=\"\"></label>\r\n");
      out.write("\t\t\t\t\t<div class=\"form-item-content-box\" style=\"\">\r\n");
      out.write("\t\t\t\t\t\t<input id=\"username\" type=\"text\" name=\"username\" style=\"width: 100%; height: 43px; border: 0px solid #e5e5e5; padding: 12px 30px 11px 0; outline: none;\" placeholder=\"请输入用户名\"/>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"form-item\" style=\"margin-top: 2px; margin-bottom: 5px;\">\r\n");
      out.write("\t\t\t\t\t<label for=\"\" class=\"form-item-label icon-unlock-alt icon-mobile2-win\" style=\"font-size: 20px;\"></label>\r\n");
      out.write("\t\t\t\t\t<div class=\"form-item-content-box\" style=\"\">\r\n");
      out.write("\t\t\t\t\t\t<input id=\"password\" type=\"text\" name=\"password\" style=\"width: 100%; height: 43px; border: 0px solid #e5e5e5; padding: 12px 30px 11px 0; outline: none;\" placeholder=\"请输入密码\"/>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"form-item\" style=\"margin-top: 2px; margin-bottom: 5px;\">\r\n");
      out.write("\t\t\t\t\t<label for=\"\" class=\"form-item-label icon-unlock-alt icon-mobile2-win\" style=\"font-size: 20px;\"></label>\r\n");
      out.write("\t\t\t\t\t<div class=\"form-item-content-box\" style=\"\">\r\n");
      out.write("\t\t\t\t\t\t<input id=\"confirm_password\" type=\"text\" name=\"confirm_password\" style=\"width: 100%; height: 43px; border: 0px solid #e5e5e5; padding: 12px 30px 11px 0; outline: none;\" placeholder=\"请再次输入密码\"/>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"form-item\" style=\"margin-top: 2px; margin-bottom: 5px;\">\r\n");
      out.write("\t\t\t\t\t<label for=\"\" class=\"form-item-label icon-envelope-o icon-mobile2-win\" style=\"font-size: 15px;\"></label>\r\n");
      out.write("\t\t\t\t\t<div class=\"form-item-content-box\" style=\"\">\r\n");
      out.write("\t\t\t\t\t\t<input id=\"captcha\" type=\"text\" name=\"captcha\" style=\"width: 100%; height: 43px; border: 0px solid #e5e5e5; padding: 12px 30px 11px 0; outline: none;\" placeholder=\"请输入验证码\"/>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"form-item\" style=\" margin-top: 2px; margin-bottom: 5px;\">\r\n");
      out.write("\t\t\t\t\t<a id=\"submit\" href=\"javascript: void(0);\" name=\"submit\" style=\"width: 100%; height: 44px; line-height: 44px; display: block; color: #fff; background-color: #ff3c3c; border-radius: 5px; -webkit-border-radius: 5px;text-align: center; font-size: 1.4rem;\">注册</a>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</form>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
