...
public final class register2_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<!-- \r\n");
      out.write("<script type=\"text/viewscript\" src=\"_tips.tmpl\" ></script>\r\n");
      out.write(" -->\r\n");
      out.write("</head>\r\n");
      out.write("<body id=\"body\" topmargin=\"0\" rightmargin=\"0\" bottommargin=\"0\" leftmargin=\"0\" marginheight=\"0\" marginwidth=\"0\">\r\n");
      ...
      out.write("\t\t<div id=\"div-reg-mobile\" style=\"width: 320px; margin: 0px auto; display: none;\">\r\n");
      ...
      out.write("\t\t</div>\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t<div id=\"div-reg-username\" style=\"width: 320px; margin: 0px auto;\">\r\n");
      out.write("\t\t\t<form action=\"\">\r\n");
      out.write("\t\t\t\t<div style=\"width: 300px; margin: 0px auto; padding: 0px 10px;\">\r\n");
      out.write("\t\t\t\t\t<div class=\"form-item\" style=\"margin-top: 2px; margin-bottom: 5px;\">\r\n");
      out.write("\t\t\t\t\t\t<label for=\"\" class=\"icon-mobile2 icon-mobile2-win form-item-label\" style=\"line-height: 44px;\"></label>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-item-content-box\" style=\"\">\r\n");
      out.write("\t\t\t\t\t\t\t<input id=\"username\" type=\"text\" name=\"username\" style=\"height: 43px; border: 0px solid #e5e5e5; padding: 12px 30px 11px 0; outline: none;\" placeholder=\"请输入用户名\"/>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"form-item\" style=\"margin-top: 2px; margin-bottom: 5px;\">\r\n");
      out.write("\t\t\t\t\t\t<label for=\"\" class=\"form-item-label icon-unlock-alt icon-mobile2-win\" style=\"font-size: 20px; line-height: 44px;\"></label>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-item-content-box\" style=\"\">\r\n");
      out.write("\t\t\t\t\t\t\t<input id=\"password\" type=\"password\" name=\"password\" style=\"height: 43px; border: 0px solid #e5e5e5; padding: 12px 30px 11px 0; outline: none;\" placeholder=\"请输入密码\"/>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"form-item\" style=\"margin-top: 2px; margin-bottom: 5px;\">\r\n");
      out.write("\t\t\t\t\t\t<label for=\"\" class=\"form-item-label icon-envelope-o icon-mobile2-win\" style=\"font-size: 15px; line-height: 44px;\"></label>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-item-content-box\" style=\"\">\r\n");
      out.write("\t\t\t\t\t\t\t<input id=\"captcha\" type=\"text\" name=\"captcha\" style=\"width: 120px; height: 43px; border: 0px solid #e5e5e5; padding: 12px 30px 11px 0; outline: none;\" placeholder=\"请输入验证码\"/>\r\n");
      out.write("\t\t\t\t\t\t\t<img alt=\"\" src=\"/captcha.shtml\"/>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"form-item\" style=\" margin-top: 2px; margin-bottom: 5px;\">\r\n");
      out.write("\t\t\t\t\t\t<a id=\"submit\" href=\"javascript: void(0);\" name=\"submit\" style=\"width: 100%; height: 36px; line-height: 36px; display: block; color: #fff; background-color: #ff3c3c; border-radius: 5px; -webkit-border-radius: 5px;text-align: center; font-size: 1.4rem;\">注册</a>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</form>\r\n");
      out.write("\t\t</div>\r\n");
      ...
      out.write("\t\t\t<a id=\"bt-reg\" href=\"javascript: void(0);\">手机注册</a>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
